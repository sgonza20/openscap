...
WARNING: Skipping https://www.redhat.com/security/data/oval/v2/RHEL7/rhel-7.oval.xml.bz2 file which is referenced from XCCDF content
----
...
--profile xccdf_org.ssgproject.content_profile_common \
/usr/share/xml/scap/ssg/content/ssg-rhel7-ds.xml
Downloading: https://www.redhat.com/security/data/oval/v2/RHEL7/rhel-7.oval.xml.bz2 ... ok
